...
class CustomerDropOffPage extends StatefulWidget {
  static const route = "/customerDropOff";
  CustomerInfo customerInfo;
  GeoPoint geoPoint = GeoPoint(latitude: 27.6866, longitude: 83.4323);
  CustomerDropOffPage({required this.customerInfo, super.key});

  @override
  State<CustomerDropOffPage> createState() => _CustomerDropOffPageState();
}

class _CustomerDropOffPageState extends State<CustomerDropOffPage> {
